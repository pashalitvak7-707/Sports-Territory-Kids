...
/* ===== Документы сайта =====
 * Карточки раздела «Документы» и вкладки «Документы» в админке.
 * Это только значения ПО УМОЛЧАНИЮ: список редактируется в админке и
 * хранится в настройке docs.items (JSON-массив [{key, name}]).
 *
 * key  — ключ настройки, в котором лежит ссылка на загруженный файл.
 * sys  — документ, на который ссылается что-то ещё, кроме страницы
 *        «Документы» (галочки согласия под формами, окно согласия на куки).
 *        Такие карточки можно переименовать и заменить у них файл, но их
 *        ключ менять нельзя, иначе ссылка в галочке перестанет работать. */
window.TSK_DOCS_DEFAULT = [
  { key: 'doc.privacy', name: 'Политика конфиденциальности',
    sys: 'подвал сайта, галочки под всеми формами, окно согласия на куки' },
  { key: 'doc.pd_policy', name: 'Политика обработки персональных данных',
    sys: 'галочки под всеми формами' },
  { key: 'doc.consent_metrika', name: 'Согласие на обработку персональных данных (Яндекс.Метрика)',
    sys: 'окно согласия на куки при входе на сайт' },
  { key: 'doc.consent', name: 'Согласие на обработку персональных данных (запись на занятие)',
    sys: 'галочки под формами записи' },
  { key: 'doc.consent_review', name: 'Согласие на обработку персональных данных (отзыв)',
    sys: 'галочка под формой отзыва' },
  { key: 'doc.oferta', name: 'Публичная оферта', sys: 'подвал сайта' }
];
